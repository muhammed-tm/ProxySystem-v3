...
public class BetaSystemCommands extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
        ...
        message.getAuthor().openPrivateChannel().complete().sendMessage("Du wurdest erfolgreich zum Betaprogramm hinzugefügt. Ab Freitag dem 20.08.21 um 18:00 Uhr kannst du auf das HypeTime.eu Netzwerk joinen. Viel Spaß auf unserem Netzwerk").queue();

        message.getChannel().sendMessage("Du wurdest erfolgreich zum Betaprogramm hinzugefügt. Ab Freitag dem 20.08.21 um 18:00 Uhr kannst du auf das HypeTime.eu Netzwerk joinen. Viel Spaß auf unserem Netzwerk").queue(message1 -> message1.delete().queueAfter(25, TimeUnit.SECONDS));
    }
